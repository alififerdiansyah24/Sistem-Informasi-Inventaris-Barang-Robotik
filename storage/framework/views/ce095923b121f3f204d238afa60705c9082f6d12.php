...
unset($__errorArgs, $__bag); ?>"
                                            name="nama_lengkap" value="<?php echo e(old('nama_lengkap', $user->nama_lengkap ?? '')); ?>"
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <?php if($user->foto): ?>
                                            <div class="row">
                                                <img src="<?php echo e(asset('img/user/' . $user->foto)); ?>"
                                                    class="img-preview mb-3 col-sm-3 d-block"
                                                    data-src="<?php echo e(asset('img/user/' . $user->foto)); ?>">
                                            </div>
                                        <?php else: ?>
                                            <div class="row">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\AA\Inventaris-Pro-main\Inventaris-Pro-main\resources\views/pages/user/edit.blade.php ENDPATH**/ ?>